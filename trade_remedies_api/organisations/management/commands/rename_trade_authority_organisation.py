...
class Command(BaseCommand):
    ...
    def handle_undo(self):
        ...
        # only perform the operation if all three objects have been found
    ...
    def handle_commit(self, trade_authority_organisation, submission_document_type, job_title):
    ...
    def handle(self, *args, **options):
        ...
        # do all or none
        if not (trade_authority_organisation and submission_document_type and job_title):
            raise CommandError(
                "commit:  NO UPDATES COMMITTED as not all objects "
                "that require update were found."
            )

        self.handle_commit(trade_authority_organisation, submission_document_type, job_title)
        return
