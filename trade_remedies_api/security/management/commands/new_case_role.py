...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("name", type=str, help='CaseRole name. E.g., "Overseas Producer"')
        parser.add_argument("plural", type=str, help='CaseRole plural. E.g., "Overseas Producers"')
        parser.add_argument("key", type=str, help="CaseRole key. E.g., overseas_producer")
    ...
    def handle(self, *args, **options):
        if options["factor"]:
            ...
            self.stdout.write(self.style.SUCCESS(f"Order values multiplied by {options['factor']}"))
        ...
        self.stdout.write(self.style.SUCCESS(f"New CaseRole created: {options['name']}"))
